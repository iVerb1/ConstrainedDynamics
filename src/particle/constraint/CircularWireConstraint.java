...
public class CircularWireConstraint extends Constraint {
    ...
    public CircularWireConstraint(Vector2f center, Particle particle, double radius) {
        this.center = new Vector3f(center.x, center.y, 0);
        this.particle = particle;
        this.radius = radius;
    }

    public CircularWireConstraint(Vector3f center, Particle particle, double radius) {
        this.center = center;
        this.particle = particle;
        this.radius = radius;
    }
